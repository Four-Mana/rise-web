...
export const Album = ({ bgVariant = "transparent" }: AlbumProps) => {
  return (
    <section className={`bg-black w-full px-8 ${variants[bgVariant]}`} >
      <div className='mx-auto grid md:grid-cols-2 max-w-5xl max-h-screen gap-x-6 py-20'>
        ...
        <div className='flex flex-col gap-3 '>
          ...
          <div className='mt-12 grid gap-6'>
            ...
            <div className='flex flex-wrap gap-6 md:gap-10 w-full py-4 bg-white/30 justify-center items-center rounded-full'>
              <Link
