...
export const DesktopNavbar = () => {
    ...
    return (
        <nav className={`w-full px-6 py-2 z-40 fixed top-0 transition-all duration-200 ease-out ${isPastNavbar ? 'bg-black shadow-lg' : ' bg-transparent'}`}data-testid='desktop-navbar'>
